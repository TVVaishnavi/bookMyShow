...
jest.mock('../src/service/seat'); // Mock the entire service
jest.mock('../src/model/seat'); // Mock the Seat model
...
describe('Seat Controller and Service Tests', () => {
  ...
  describe('Seat Service', () => {
    test('getAvailableSeats should return available seats', async () => {
      ...
      // Mock Seat.find to resolve with mockSeats
    ...
    test('reserveSeat should reserve a seat', async () => {
      ...
      mockSeat.status = 'Reserved'; // Simulate the reservation
